                        ...
                        <div class="col-md-12 breadcumb_part">
                            <div class="bread">
                                <ul>
                                    ...
                                    <li class="{{ Request::is('admin/dashboard') ? 'active' : '' }}"><a href="{{url('dashboard')}}"><i class="fas fa-angle-double-right"></i>Dashboard</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid footer_part">
            <div class="row">
                ...
                <div class="col-md-10 copyright">
                    <p>Copyright &copy; 2022 | All rights reserved by <a href="{{url('')}}">khalid hsan shafi</a> | Development By <a href="#">{{Auth::user()->name}}</a></p>
                </div>
                <div class="clr"></div>
            </div>
        </div>
